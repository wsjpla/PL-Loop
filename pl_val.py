...
def evaluate(gt_txt):
    ...
    for line in tqdm(fp):
        ...
        inlier_ratio.append(loop_verification(query, reference, new_size=None, is_vis=False, crop=True))
        labels.append(gt)
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        precision, recall, thresholds = precision_recall_curve(labels, inliers)
        ...
        plt.legend()
        plt.title("Precision-Recall Curves for Point+Line")
        plt.savefig("PL_{}.png".format(dataset.strip(".txt")))
        plt.close()
    ...
    # plt.savefig("pr_curve_SuperPoint+perGlue.png")
